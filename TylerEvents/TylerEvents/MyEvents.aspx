...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="UpcommingEventsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT Events.RecId, Events.EventName, Events.Location, Events.OwnerId, Events.Description, Events.MinParticipants, Events.MaxParticipants, Events.StartDateTime, Events.EndDateTime, Participants.UserId, Participants.EventId, AspNetUsers.* FROM Events INNER JOIN Participants ON Events.RecId = Participants.EventId INNER JOIN AspNetUsers ON Participants.UserId = AspNetUsers.Id"></asp:SqlDataSource>
